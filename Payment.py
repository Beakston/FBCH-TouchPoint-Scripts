...
print '''<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        ...
        <button onclick="window.location.href='{0}/PyScript/Member%20Manager?ProgramName=''' + ProgramName + '''&ProgramID=''' + ProgramId + '''';"><i class="fa fa-home"></i></button>'''.format(model.CmsHost,model.Data.pid)